...
namespace DutchTreat.Migrations
{
    ...
    [Migration("20210819200643_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2021, 8, 19, 20, 6, 42, 721, DateTimeKind.Utc).AddTicks(618),
                            OrderNumber = "12345"
                        });
                });
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.UserStorage", b =>
                {
            ...
            modelBuilder.Entity("DutchTreat.Data.Entities.Order", b =>
                {
                    b.HasOne("DutchTreat.Data.Entities.UserStorage", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DutchTreat.Data.Entities.UserStorage", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
